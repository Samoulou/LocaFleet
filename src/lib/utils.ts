 ...
 * Unlike toISOString().split("T")[0], this does NOT convert to UTC first.
 * Safe for timezone-sensitive date pickers and API params.
 */
 ...
 * Unlike new Date(dateStr), this does NOT interpret the string as UTC.
 */
