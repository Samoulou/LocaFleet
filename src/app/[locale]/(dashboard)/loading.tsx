  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="h-9 w-32 rounded-md bg-slate-200 animate-pulse" />
        <div className="h-9 w-48 rounded-md bg-slate-200 animate-pulse" />
      </div>

      {/* Table skeleton */}
      <div className="rounded-lg border border-slate-200 bg-white overflow-hidden">
        {/* Table header */}
        <div className="h-12 border-b border-slate-200 bg-slate-50 px-4 flex items-center gap-4">
        ...
        {[...Array(6)].map((_, i) => (
          <div
            key={i}
            className="h-14 border-b border-slate-100 px-4 flex items-center gap-4"
          >
            ...
            <div className="h-4 w-16 rounded-md bg-slate-200 animate-pulse ml-auto" />
          </div>
        ))}
      </div>
